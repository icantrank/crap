...
.method public constructor <init>(Ljava/lang/String;[Ljava/io/File;Lcom/googlecode/mp4parser/authoring/Track;)V
    ...
    invoke-virtual {v4, v8}, Lcom/googlecode/mp4parser/boxes/mp4/ESDescriptorBox;->setData(Ljava/nio/ByteBuffer;)V

    const/4 v8, -0x1

    const-string v9, "038080801B000100048080800D6C11000000000A1CB4000A1CB4068080800102"

    .line 68
    invoke-static {v9}, Lcom/coremedia/iso/Hex;->decodeHex(Ljava/lang/String;)[B
    ...
    invoke-static {v8, v9}, Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/ObjectDescriptorFactory;->createFrom(ILjava/nio/ByteBuffer;)Lcom/googlecode/mp4parser/boxes/mp4/objectdescriptors/BaseDescriptor;
    ...
    .line 80
    invoke-virtual {v4}, Lcom/googlecode/mp4parser/authoring/Edit;->getMediaTime()J
    ...
    invoke-virtual {v4}, Lcom/googlecode/mp4parser/authoring/Edit;->getTimeScale()J
